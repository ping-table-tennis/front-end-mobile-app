...
//         // setParam(props.route.params.name)
...
//                 <TextInput placeholder="Full Name" value={name} onChangeText={text => setName(text)} style={styles.input}/>
...
//                     <TextInput placeholder="Current Rating" value={rating} onChangeText={num => setRating(num)} style={styles.input} />
//                 </View>
//             </View>
//             <View style={styles.buttonContainer}>
